...
<html class="fixed">
	...
	<body>
		<!-- start: page -->
		<section class="body-sign body-locked" style="background-color: #777;">
			<div class="center-sign">
				<div class="panel panel-sign">
					<div class="panel-body">
						<form action="index.html">
							<div class="current-user text-center">
								<img src="<?php echo base_url();?>assets/images/!logged-user.jpg" alt="John Doe" class="img-circle user-image" />
