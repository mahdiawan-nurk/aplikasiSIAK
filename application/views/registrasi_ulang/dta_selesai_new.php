<section class="content-with-menu mailbox">
						<div class="content-with-menu-container" data-mailbox data-mailbox-view="folder">
							...
							<header class="panel-heading">
										...
										<h2 class="panel-title">Data Histori Mahasiswa Terdaftar Tahun Akademik</h2>
									</header>
							<br>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#mydata').DataTable({
                ...
                "serverSide": false, 
                "order": [], 
                  "sAjaxSource": "<?php echo site_url('r_selesai_daftar/data_selesai_reg')?>",
                  // "autoWidth": false,
		...
		$('#cari_data').on('click',function () {
			...
			$.ajax({
                type : "POST",
                url  : "<?php echo site_url('r_selesai_daftar/list_kelas')?>",
